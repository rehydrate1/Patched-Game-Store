...
export const metadata = {
    title: 'Гарантии | Patched',
    description: 'На этой странице вы можете узнать почему уже тысячи геймеров доверяют нам',
}
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 pb-50">
                    <div className="flex items-start space-x-4">
                        <div className="flex-shrink-0"><KeyIcon className="h-10 w-10 text-[#00FE92]" /></div>
                        <div>
                    ...
                    <div className="flex items-start space-x-4">
                        <div className="flex-shrink-0"><BoltIcon className="h-10 w-10 text-[#00FE92]" /></div>
                        <div>
                    ...
                    <div className="flex items-start space-x-4">
                        <div className="flex-shrink-0"><ShieldCheckIcon className="h-10 w-10 text-[#00FE92]" /></div>
                        <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-center space-x-3"><ChatBubbleLeftRightIcon className="h-6 w-6 text-[#00FE92] flex-shrink-0" /><span>Отзывчивая поддержка 24/7</span></li>
                                <li className="flex items-center space-x-3"><CloudArrowDownIcon className="h-6 w-6 text-[#00FE92] flex-shrink-0" /><span>Гарантия активации ключа</span></li>
                                <li className="flex items-center space-x-3"><UserGroupIcon className="h-6 w-6 text-[#00FE92] flex-shrink-0" /><span>Сильное сообщество и акции</span></li>
                            </ul>
                        </div>
