...
export default function KeysCatalog() {
    ...
    return (
        <div className="flex flex-col md:flex-row container mx-auto my-10 gap-8">
            <aside className={`text-white p-6 rounded-lg w-full md:w-1/4 mainColor h-fit`}>
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center gap-2">
                        <FilterInput
                            type={'number'}
                            value={priceFrom.inputState.value}
                            onChange={priceFrom.setValue}
                            placeholder={'От'}
                            min={'0'}
                            id={'priceFrom'}
                        />
                        ...
                        <FilterInput
                            type={'number'}
                            value={priceTo.inputState.value}
                            onChange={priceTo.setValue}
                            placeholder={'До'}
                            min={'0'}
                            id={'priceTo'}
                        />
